...
def remove_chat_metadata(chat_export_file):
    ...
    return cleaned_corpus.split("\n")

def remove_non_message_text(export_text_lines):
    messages = export_text_lines[1:-1]

    # Add more patterns to filter out as needed
    filter_out_msgs = ("<Media omitted>", "Some other pattern", "Another pattern")

    return [msg for msg in messages if not any(pattern in msg for pattern in filter_out_msgs)]

if __name__ == "__main__":
    # Add some testing or example usage here
    pass
...
#     ---------------------------------------
#     8/26/22, 17:47 - Jane Doe: Message texta
